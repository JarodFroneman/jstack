...
> forward by this release, and v0.9 replaces its launch-evidence protocol with
> structured Launch Assurance v2. See
> [migration-0.8.2.md](migration-0.8.2.md) and
